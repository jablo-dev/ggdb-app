...
@Component({
        ...
        <div *ngIf="currentToast" class="layout-toast-bar" [ngClass]="currentToast.severity" @slideUp>
            <div class="layout-toast-bar-content">
                <div class="toast-info">
                    <i class="pi" [ngClass]="{
                        'pi-check-circle': currentToast.severity === 'success',
                        'pi-exclamation-triangle': currentToast.severity === 'error' || currentToast.severity === 'warn',
                        'pi-info-circle': currentToast.severity === 'info'
                    }"></i>
    ...
    styles: [`
        .layout-toast-bar {
            ...
            &.success {
                ...
                .pi { color: #ffffff; }
                .toast-progress-value { background-color: rgba(255, 255, 255, 0.7); }
            }
            &.error {
    ...
    animations: [
        trigger('slideUp', [
            ...
            transition(':leave', [
                animate('400ms cubic-bezier(0.25, 1, 0.5, 1)', style({ transform: 'translateY(100%)', opacity: 0 }))
            ])
        ])
    ]
})
