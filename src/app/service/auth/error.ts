...
@Component({
    selector: 'app-error',
    imports: [RouterModule, AppFloatingConfigurator, MaterialUiModule],
    standalone: true,
                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                        <div class="gap-4 flex flex-col items-center">
                            <div class="flex justify-center items-center border-2 border-pink-500 rounded-full" style="height: 3.2rem; width: 3.2rem">
                                <i aria-hidden="true" class="bi bi-fw bi-exclamation-circle !text-2xl text-pink-500"></i>
                            </div>
                            ...
                            <div class="col-span-12 mt-8 text-center">
                                <app-action label="Go to Dashboard" routerLink="/" severity="danger" />
                            </div>
                        </div>
                    </div>
                </div>
